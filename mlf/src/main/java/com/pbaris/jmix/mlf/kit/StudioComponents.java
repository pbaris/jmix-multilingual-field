    ...
    @StudioComponent(
        ...
        properties = {
            ...
            @StudioProperty(xmlAttribute = "localeMode", type = StudioPropertyType.ENUMERATION,
                ...
                defaultValue = "SYSTEM",
                options = {"SYSTEM", "USER"}),
            @StudioProperty(xmlAttribute = "multilineHeight",
                category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
            @StudioProperty(xmlAttribute = "multilineMinHeight",
                category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
            @StudioProperty(xmlAttribute = "multilineMaxHeight",
                category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
        },
        propertiesBindings = {
