...
|2.7.x|1.4.0|gr.netmechanics.jmix:jmix-multilingual-field-starter:1.4.0
|2.8.x|1.5.0|gr.netmechanics.jmix:jmix-multilingual-field-starter:1.5.0
|3.0.x|3.0.0|gr.netmechanics.jmix:jmix-multilingual-field-starter:3.0.0
|===
